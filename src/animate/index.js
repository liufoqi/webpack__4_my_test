...
import moreRanslow from './moreRanslow'
import moreRanFast from './moreRanFast'
import fastAndSlowFast from './fastAndSlowFast'
import slowAndFastSlow from './slowAndFastSlow'
let animateType={
    linner:linner,
    fastAndSlow:fastAndSlow,
    moreRanslow:moreRanslow,
    moreRanFast:moreRanFast,
    fastAndSlowFast:fastAndSlowFast,
    slowAndFastSlow:slowAndFastSlow,
}
